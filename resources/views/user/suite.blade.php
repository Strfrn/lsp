      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{route('rooms')}}">Home</a></span> <span class="mr-2"><a href="{{route('rooms')}}">Rooms</a></span> <span>deluxe rooms</span></p>
	            <h1 class="mb-4 bread">Deluxe Rooms</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-8">
          	<div class="row">
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Deluxe Room <span>- (4 Available rooms)</span></h2>
