    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('kamar.update', $rooms->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="room_number" name="room_number" value="{{$rooms->room_number}}" class="form-control" required>
                        </div>
                        <div class="form-group">
